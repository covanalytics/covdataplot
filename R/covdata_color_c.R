...
#' covdata_color_c
#'
#' @description  This function is used to apply a color aesthetic to a continuous variable.
...
#' @keywords covdata_color_c
#' @references Jumping Rivers--Custom colour palettes for {ggplot2}
#' @examples
#' cov_graph +
#' geom_point(stat = "identity", aes(color = Amount), size = 4)+
