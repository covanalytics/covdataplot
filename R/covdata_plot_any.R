...
#' It will add a footer that can include any logo at the bottom left and a horizontal
...
#' @param logo the name of the logo to use.
#' @param logo_width the width adjustment in inches to the logo (default is set to 1.4)
